...
constexpr i32 operator"" _i32(int v)
{
    return v;
}
constexpr i32 operator"" _u32(int v)
{
    return v;
}
constexpr i64 operator"" _i64(int v)
{
    return v;
}
constexpr u64 operator"" _u64(int v)
{
    return v;
}
constexpr f64 operator"" _f64(int v)
{
    return v;
}
constexpr f80 operator"" _f80(int v)
{
    return v;
}
